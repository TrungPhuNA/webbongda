    ...
    $contact = $db->fetchJone('contact',$sql,$p, 5,true);
  
    if(isset($contact['page']))
    {
        $sotrang =  $contact['page'];
        unset($contact['page']); 
    }
                    ...
                    <tr>
                       ...
                       <td>
                           <?php if($item['action'] == 1) :?>
                                <a href="action.php?id=<?php echo $item['id'] ?>" title="" class="btn btn-info btn-xs">Đã Contact</a>
                           <?php else :?>
                                 <a href="action.php?id=<?php echo $item['id'] ?>" title="" class="btn btn-default btn-xs">Chưa</a>
                           <?php endif ;?>
                       </td>
